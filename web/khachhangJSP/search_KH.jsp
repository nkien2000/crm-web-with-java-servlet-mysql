<%-- 
    Document   : search_KH
    Created on : Dec 1, 2021, 4:11:52 PM
    Author     : admin
--%>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="input-find">
                        <form class="" method="post" action="search_KH.jsp">
                            <input type="text" class="searchbox" name="name" placeholder="Họ tên">
                            <input type="text" class="searchbox" name="diachi" placeholder="Email">
                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover table-data">
                        ...
                        <%
                            try {
                                ...
                                String sql = "select * from khachhang1 where name like '%" + name + "%' and diachi like '%" + diachi + "%' and phone like '%" + sodienthoai + "%' and trangthai like '%" + trangthai + "%'";
                        ...
                        <tr>
                            ...
                            <td><a href="LayDLKhachhang.jsp?id=<%=resultSet.getString("id")%>"><img src="../assets/img/edit.png" style="width:30px; height:30px"></a></td>
                            <td><a href="XoaKhachhang.jsp?id=<%=resultSet.getString("id")%>" onclick="if (confirm('Bạn có chắc chắn xóa không?'))
                                        return true;
