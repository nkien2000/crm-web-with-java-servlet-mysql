...
<body >
    <div class="form-tt" >
        <form method="post" action="Add_Core.jsp">
            <table align="center">
                <div id="container">
                ...
                <input type="date" name="ngaydk" placeholder="Created_at"/> 
                 <select name="loai" id="loai">
                    <option name="loai" value="2"> Customer </option>
                </select>
                <input id="login" type="submit" value="Register" name="sbm"  />
               
                <a id="am" href="dangnhap.jsp">Da co tai khoan? </a>
                </div>
            </table>
        </form>
    </div>
