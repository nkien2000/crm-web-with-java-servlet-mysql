<%-- 
    Document   : Add_khachhang
    Created on : Nov 28, 2021, 11:14:51 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="title-color">Thêm thông tin khách hàng</h4>
                    <form action="xuli_themKhachhang.jsp" method="POST" class="form-update">
                        <div class="form-group">
                            <label for="hoten">Họ tên: </label>
                            <input required="true" type="text" name="txt_tenKhachhang" id="hoten" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="sdt">Số điện thoại: </label>
                            <input required="true" type="text" name="txt_phoneKhachhang" id="sdt" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="ac_id">AccountId: </label>
                            <input required="true" type="text" name="txt_accountidKhachhang" id="ac_id" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="diachi">Địa chỉ: </label>
                            <input required="true" type="text" name="txt_diachiKhachhang" id="diachi" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="trangthai">Trạng thái: </label>
                            <input required="true" type="text" name="txt_trangthaiKhachhang" id="trangthai" class="form-control">
                        </div>
